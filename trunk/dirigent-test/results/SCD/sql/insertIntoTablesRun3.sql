...
Insert into L0_CUSTOMER (CUSTOMER_ID,ADDRESS_ID,FIRST_NAME,SURNAME) values (7,6,'Vitaliy','Pogodin');
...
Insert into L0_INVOICE (INVOICE_ID,CUSTOMER_ID,DUE_DATE,PAYMENT_DATE,PAYMENT_FLAG) values (7,7,to_timestamp('30-DEC-10 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),to_timestamp('25-OCT-10 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'1');
...
Insert into L0_INVOICE_ITEM (INVOICE_ITEM_ID,PRODUCT_ID,INVOICE_ID,AMOUNT) values (7,7,7,3);
Insert into L0_INVOICE_ITEM (INVOICE_ITEM_ID,PRODUCT_ID,INVOICE_ID,AMOUNT) values (8,7,2,1);
