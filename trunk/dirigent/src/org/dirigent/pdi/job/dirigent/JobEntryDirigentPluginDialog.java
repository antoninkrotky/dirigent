...
public class JobEntryDirigentPluginDialog extends JobEntryDialog implements
	...
	public JobEntryInterface open() {
		...
		shell.setText(BaseMessages.getString(PKG, "JobEntryDirigentPluginDialog.ShellTitle")); //$NON-NLS-1$
		...
		wlStepname.setText(BaseMessages
				.getString(PKG, "JobEntryDirigentPluginDialog.StepnameLabel")); //$NON-NLS-1$
